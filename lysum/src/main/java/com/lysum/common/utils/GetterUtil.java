...
public class GetterUtil {
	...
	public static boolean get(String value, boolean defaultValue) {
		...
		try {
			...
			if (value.equals(BOOLEANS[0]) || value.equals(BOOLEANS[1]) || value.equals(BOOLEANS[2]) || value.equals(BOOLEANS[3])
	...
	public static Integer[] getIntegerValues(Object value) {
		return getIntegerValues(value, DEFAULT_INTEGER_VALUES);
	}

	public static Integer[] getIntegerValues(Object value, Integer[] defaultValue) {
		Class<?> clazz = value.getClass();
